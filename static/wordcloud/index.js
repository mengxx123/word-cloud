...
var app = new Vue({
    ...
    data: function () {
        return {
            ...
            dppx: 1,
            masks: [
                '/asset/wordcloud/img/mask-heart.png',
                '/asset/wordcloud/img/mask-apple.png',

                '/asset/wordcloud/img/mask-rect.png',
                '/asset/wordcloud/img/mask-ellipse.png',

                '/asset/wordcloud/img/mask-china.png',
                '/asset/wordcloud/img/mask-us.png',

                '/asset/wordcloud/img/mask-qiaobusi.png',

                '/asset/wordcloud/img/mask-rabbit.png',
                '/asset/wordcloud/img/mask-fish.png',
                '/asset/wordcloud/img/mask-cat.png',
                '/asset/wordcloud/img/mask-bird.png',
                '/asset/wordcloud/img/mask-butterfly.png',

                '/asset/wordcloud/img/mask-girl.png',
                '/asset/wordcloud/img/mask-man.png',
                '/asset/wordcloud/img/mask-play.png',

                '/asset/wordcloud/img/mask-1.png',
                '/asset/wordcloud/img/mask-2.png',
                '/asset/wordcloud/img/mask-3.png',
                '/asset/wordcloud/img/mask-4.png',
                '/asset/wordcloud/img/mask-5.png',
                '/asset/wordcloud/img/mask-6.png',
                '/asset/wordcloud/img/mask-7.png',
                '/asset/wordcloud/img/mask-a.png',
                '/asset/wordcloud/img/mask-b.png',
                '/asset/wordcloud/img/mask-c.png',
                '/asset/wordcloud/img/mask-d.png',
                '/asset/wordcloud/img/mask-e.png',
                '/asset/wordcloud/img/mask-f.png',
                '/asset/wordcloud/img/mask-g.png',
                '/asset/wordcloud/img/mask-h.png',
                '/asset/wordcloud/img/mask-i.png',
                '/asset/wordcloud/img/mask-j.png',
                '/asset/wordcloud/img/mask-k.png',
                '/asset/wordcloud/img/mask-l.png',
                '/asset/wordcloud/img/mask-m.png',
                '/asset/wordcloud/img/mask-m.png',
                '/asset/wordcloud/img/mask-o.png',
                '/asset/wordcloud/img/mask-p.png',
                '/asset/wordcloud/img/mask-q.png',
                '/asset/wordcloud/img/mask-r.png',
                '/asset/wordcloud/img/mask-s.png',
                '/asset/wordcloud/img/mask-t.png',
                '/asset/wordcloud/img/mask-u.png',
                '/asset/wordcloud/img/mask-v.png',
                '/asset/wordcloud/img/mask-w.png',
                '/asset/wordcloud/img/mask-x.png',
                '/asset/wordcloud/img/mask-y.png',
                '/asset/wordcloud/img/mask-z.png'
            ]
        }
    },
    methods: {
